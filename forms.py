...
class PersonnelForm(FlaskForm):
    ...
    clever_email = StringField("Google Email")
    clever_password = StringField("Google Password")
    powerschool_email = StringField("Google Email")
    powerschool_password = StringField("Google Password")
